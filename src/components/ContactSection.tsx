...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'shivamsonawane767@gmail.com',
    href: 'mailto:shivamsonawane767@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 80871 42499',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/918087142499',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/shivamsonawane2005',
    href: 'https://www.linkedin.com/in/shivamsonawane2005',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@Shivamds143',
    href: 'https://github.com/Shivamds143',
  },
];
...
const ContactSection = () => {
  return (
    ...
    >
      ...
      <FadeIn y={40}>
        <h2
          className="hero-heading text-center font-black uppercase tracking-tight leading-none mb-4 break-words"
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          <span
            ...
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            © 2026 Shivam Sonawane
          </span>
          <span
            className="font-light uppercase tracking-widest text-[#D7E2EA]/50"
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            Designed & built in Nashik
          </span>
        </div>
      </FadeIn>
    </section>
