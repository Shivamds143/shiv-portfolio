...
const PROJECTS: ProjectData[] = [
  {
    number: '01',
    category: 'Java · Spring Boot · React.js',
    name: 'Financial CRM',
    liveUrl: 'https://github.com/Shivamds143',
    col1Image1: '/projects/financial-crm-1.png',
    col1Image2: '/projects/financial-crm-2.png',
    col2Image: '/projects/financial-crm-3.png',
  },
  {
    number: '02',
    category: 'Java · Spring Boot · React.js',
    name: 'To-Do Task Management System',
    liveUrl: 'https://github.com/Shivamds143',
    col1Image1: '/projects/todo-task-1.jpeg',
    col1Image2: '/projects/todo-task-2.jpeg',
    col2Image: '/projects/todo-task-3.jpeg',
  },
  {
    number: '03',
    category: 'Java · Spring Boot · JavaScript',
    name: 'Smart Designer Poster System',
    liveUrl: 'https://github.com/Shivamds143',
    col1Image1: '/projects/poster-system-1.png',
    col1Image2: '/projects/poster-system-2.png',
    col2Image: '/projects/poster-system-3.png',
  },
  {
    number: '04',
    category: 'Java · Spring Boot · MySQL',
    name: 'Smart File Organizer System',
    liveUrl: 'https://github.com/Shivamds143',
    col1Image1: '/projects/file-organizer-1.png',
    col1Image2: '/projects/file-organizer-2.png',
    col2Image: '/projects/file-organizer-3.png',
  },
];
          ...
          {/* Top row: number + meta + button */}
                  <div className="flex flex-col sm:flex-row items-start sm:justify-between gap-4 sm:gap-6">
                    ...
                    <div className="shrink-0 self-start sm:self-auto pt-1 sm:pt-2 md:pt-3 w-full sm:w-auto">
                      <LiveProjectButton href={project.liveUrl} label="View Code" className="w-full sm:w-auto" />
                    </div>
                  </div>
...
const ProjectsSection = () => {
  ...
  return (
    ...
    >
      <FadeIn y={40}>
        <h2
          className="hero-heading text-center font-black uppercase tracking-tight leading-none mb-16 sm:mb-20 md:mb-28 break-words"
