...
const ABOUT_TEXT =
  "Hi, I'm Shivam Sonawane, a Computer Science student and an aspiring Full Stack Java Developer with a passion for building scalable, user-focused web applications. I enjoy transforming ideas into real-world solutions using Java, Spring Boot, React.js, MySQL, REST APIs, and AWS — with a primary focus on backend development, writing clean and maintainable code. Let's build something incredible together!";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 sm:gap-14 md:gap-16 text-center">
        <FadeIn delay={0} y={40}>
          <h2
            className="hero-heading font-black uppercase leading-none tracking-tight break-words"
                    ...
                    <FadeIn delay={0.15} className="w-full max-w-3xl">
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          {
                            label: 'Languages',
                            items: ['Java', 'JavaScript (ES6+)', 'HTML5', 'CSS3', 'SQL', 'Python'],
                          },
                          {
                            label: 'Frameworks & Libraries',
                            items: ['Spring Boot', 'Spring MVC', 'Hibernate (JPA)', 'React.js', 'Bootstrap', 'JDBC', 'Servlets', 'JSP'],
                          },
                          {
                            label: 'Databases',
                          ...
                          },
                          {
                            ...
                            items: ['Git', 'GitHub', 'Docker', 'AWS (EC2, IAM, S3)', 'Postman', 'Maven', 'VS Code', 'Eclipse IDE', 'Figma (Basic)'],
                          },
                          {
                            label: 'AI & GenAI',
                            items: ['ChatGPT', 'Google Gemini', 'GitHub Copilot', 'Cursor AI', 'Claude AI', 'Prompt Engineering'],
                          },
                          {
                            label: 'Core Concepts',
                            items: ['OOP', 'Data Structures & Algorithms', 'RESTful APIs', 'MVC Architecture', 'Auth & Authorization', 'Microservices (Basic)'],
                          },
                        ].map((group) => (
                          <div
                            key={group.label}
